...
![Terragrunt](https://img.shields.io/badge/Terragrunt-2E8555?style=flat-square&logo=terraform&logoColor=white)
...
- **Azure Landing Zone** — CAF-aligned governance, management groups, policy-as-code
- **IaC** — Terraform / Terragrunt, Azure Verified Modules, GitOps workflows
...
*Belgium-based · open to senior IC roles across EMEA*